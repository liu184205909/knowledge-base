...
### 工具相关
- [01-claude code安装指南](../../00-CC使用手册/01-claude%20code安装指南.md) - MCP服务器配置
...
基于自动化流水线的实践，未来的 Agent 产品需要三大核心组件：
...
**案例**：
- Manus：29 个工具（浏览器、Shell、文件、信息查询、消息交互）
- Deep Research Agent：联网搜索、阅读网页、文件解析
- 播客生成 Agent：联网搜索、TTS、音频合成
...
**未来方向**：
- 短期：继续完善自动化流水线（CSV+MCP）
- 长期：探索 Agent Infra（Framework+Tools+Sandbox）
