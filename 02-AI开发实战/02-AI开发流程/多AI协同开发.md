...
**如果不符**：
- 任务数量>50个？→ 查看[自动化流水线案例](./自动化流水线案例.md)
- 单一复杂功能？→ 查看[feature-dev开发流程](./feature-dev开发流程.md)
- 全栈流水线开发？→ 查看[Vibe-Coding多AI协作](./Vibe-Coding多AI协作.md)
...
**Level 1: 单AI开发**
- [feature-dev开发流程](./feature-dev开发流程.md) - 单AI深度开发
- 适用：单一复杂功能
- 效率：质量↑2-3倍
...
**Level 3: 自动化流水线**
- [自动化流水线案例](./自动化流水线案例.md) - CSV+MCP系统
- 适用：50-151个重复性任务
- 效率：10-15倍
- 门槛：高（需测试基础）
