...
BASE = r"D:\Code\knowledge-base\gsc-mock\rosetoys_audit\deepfix_sto"
...
def main():
    ...
    plan = json.load(open(os.path.join(BASE, "plan_deepfix.json"), encoding="utf-8"))
    todo = plan[a:b]
    resl_path = os.path.join(BASE, "results_deepfix.jsonl")
