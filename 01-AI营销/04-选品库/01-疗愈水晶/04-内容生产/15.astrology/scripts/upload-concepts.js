...
const idx = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'articles-concepts-index.json'), 'utf8'));
...
for (const art of list) {
  ...
  try {
    const a = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'articles-concepts', art.slug + '.json'), 'utf8'));
