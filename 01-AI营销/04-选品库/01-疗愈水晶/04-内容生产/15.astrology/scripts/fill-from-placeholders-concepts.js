/**
 * Numerology 主词页 AI 填充回填：读 _placeholders-concepts/{slug}.txt（@@@格式）
 * → 替换 articles-concepts/{slug}.json 里所有 {{AI_*}} 占位符
...
const idx = JSON.parse(fs.readFileSync(path.join(DIR, 'articles-concepts-index.json'), 'utf8'));
