 ...
 * 读 meditation-extended-knowledge.json → 主词页模板（Quick Answer/What Is/Explained+HowTo/Key Facts/Crystals内链9交叉页/Eastern/FAQ/Related）
...
const KNOW = require('../../../07-互动工具/_shared/meditation-extended-knowledge.json');
