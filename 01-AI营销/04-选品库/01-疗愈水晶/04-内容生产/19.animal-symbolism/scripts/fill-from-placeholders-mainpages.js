/**
 * Numerology 主词页 AI 填充回填：读 _placeholders-mainpages/{slug}.txt（@@@格式）
 * → 替换 articles-mainpages/{slug}.json 里所有 {{AI_*}} 占位符
...
const idx = JSON.parse(fs.readFileSync(path.join(DIR, 'articles-mainpages-index.json'), 'utf8'));
