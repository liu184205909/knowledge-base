...
|--------|------|----------|----------|---------|
| **会员分级体系** | [§4.1 会员体系](#41-会员体系免费付费) | 免费会员(每日运势/肯定语)→付费会员(月相日记/深层数据) | 设计Earthward免费/付费会员 | https://www.moonomens.com/plan/ |
...
| 借鉴项 | 具体做法 |
|--------|---------|--------|
| **免费会员+每日内容** | 注册送每日水晶能量提示+肯定语+水晶月历 |
| **免费电子书注册诱饵** | "Sign Up & Get 3 Free Crystal Guides" |
| **可打印日记产品** | 满月水晶充能日记PDF（每月更新） |
| **水晶+星座+月相电子书** | 直接复刻"Zodiac, Crystals, and Moon Rituals"概念 |
| **个性化水晶报告** | reading.goearthward.com 生成水晶能量报告 |
| **视频背景Hero** | 首页视频提升品牌调性 |
| **多站协同** | 主站+商城+工具站 |
...
### 可模仿点
1. **免费会员+每日内容** —— 注册送每日水晶能量提示+肯定语+月历，培育+回访（依据：§6.1）。落地：MemberPress 免费会员+每日水晶推送
2. **免费电子书注册诱饵** —— "Sign Up & Get 3 Free Crystal Guides"，高转化留资（依据：§6.1）。落地：3 本水晶指南 PDF 作为邮件注册诱饵
3. **可打印日记产品** —— 满月水晶充能日记 PDF（每月更新），$5-15 低门槛数字产品（依据：§6.1）。落地：Crystal Charge Journal 月度 PDF
4. **个性化解读子站** —— reading.moonomens.com 独立解读站，高转化（依据：§5）。落地：reading.goearthward.com 个性化水晶报告
5. **6 层变现漏斗** —— 免费→电子书→付费电子书→可打印→解读→实体→会员（依据：§4）。落地：我们的 6 层变现模型直接参考

### 可超越点
1. **内容核心占星非水晶** —— Moon Omens 以占星/月相为主轴，水晶只是附属（依据：§6.2）。落地：我们以水晶为主轴
2. **社区互动较浅** —— Soul Family 概念轻量（依据：§6.2）。落地：深度水晶社群+22 个互动工具+测试留资
3. **电子书为主缺乏工具** —— Moon Omens 的数字产品以 PDF 为主，无互动工具（依据：§7）。落地：我们的互动工具矩阵（Quiz/Test/Calculator）

### 差异化机会
1. **水晶×星座×月相三合一电子书** —— Moon Omens 做"Zodiac, Crystals, and Moon Rituals"但水晶维度薄弱（依据：§6.1）。落地：强化水晶维度的三合一电子书
2. **水晶能量匹配工具** —— Moon Omens 的个性化是月相解读，我们做水晶能量匹配+个性化推荐工具（依据：§6.2"个性化"差异）
