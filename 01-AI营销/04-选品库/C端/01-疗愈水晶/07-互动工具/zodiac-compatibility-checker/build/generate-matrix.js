 ...
 */
const fs = require('fs');
const ATTR = JSON.parse(fs.readFileSync('D:/Code/knowledge-base/01-AI营销/04-选品库/C端/01-疗愈水晶/07-互动工具/_shared/crystal-attributes.json', 'utf8'));
...
fs.writeFileSync('D:/Code/knowledge-base/01-AI营销/04-选品库/C端/01-疗愈水晶/07-互动工具/zodiac-compatibility-checker/data/zodiac-matrix.json', JSON.stringify(out, null, 2), 'utf8');
