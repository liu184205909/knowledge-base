/**
 * 部署 Kua Calculator 到 WP（page draft, parent=43101 /tools/, TKD）
 * 用法：node deploy-kua.js   需 socks5 + disableSandbox
 */
...
const html = fs.readFileSync(path.join(__dirname, 'kua-calculator.html'), 'utf8');
const content = '<!-- wp:html -->\n' + html + '\n<!-- /wp:html -->';
const data = {
  title: 'Kua Number Calculator: Feng Shui Directions & Crystals',
...
// TKD
const meta = {
  rank_math_title: 'Kua Number Calculator: Feng Shui Directions & Birth Crystals',
  rank_math_description: 'Calculate your feng shui Kua number from your birth date and gender. Discover your 4 auspicious directions, trigram, element, and birth crystals — free, based on BTB Eight Mansions tradition.',
  rank_math_focus_keyword: 'kua number calculator'
};
