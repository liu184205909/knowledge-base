/**
 * 部署 Wealth Corner Finder 到 WP（page draft, parent=43101 /tools/, TKD）
 * 用法：node deploy-wealth.js   需 socks5 + disableSandbox
 */
...
const html = fs.readFileSync(path.join(__dirname, 'wealth-corner.html'), 'utf8');
const content = '<!-- wp:html -->\n' + html + '\n<!-- /wp:html -->';
const data = {
  title: 'Feng Shui Wealth Corner Finder: Location & Best Crystals',
...
const meta = {
  rank_math_title: 'Feng Shui Wealth Corner Finder: Location, Activation & Crystals',
  rank_math_description: 'Find your feng shui wealth corner — BTB far back-left and classical southeast methods compared. See what to place and avoid, plus the best wealth crystals.',
  rank_math_focus_keyword: 'feng shui wealth corner'
};
