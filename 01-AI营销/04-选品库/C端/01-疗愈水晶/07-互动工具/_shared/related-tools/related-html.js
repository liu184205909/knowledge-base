...
const MAP = {
  'crystal-tarot-reading':         ['ai-tarot-chat', 'tarot-birth-card', 'yes-no-tarot'],
  ...
  'tarot-birth-card':              ['crystal-tarot-reading', 'ai-tarot-chat', 'numerology-calculator'],
  'ai-tarot-chat':                 ['crystal-tarot-reading', 'tarot-birth-card', 'yes-no-tarot'],
  ...
  'numerology-calculator':         ['tarot-birth-card', 'chinese-zodiac-checker', 'birthstone-finder'],
  'birthstone-finder':             ['chinese-zodiac-checker', 'numerology-calculator', 'moon-calendar'],
  'moon-calendar':                 ['birthstone-finder', 'chinese-zodiac-checker', 'crystal-cleansing-timer'],
  'crystal-quiz':                  ['chakra-test', 'element-test', 'crystal-bracelet-builder'],
