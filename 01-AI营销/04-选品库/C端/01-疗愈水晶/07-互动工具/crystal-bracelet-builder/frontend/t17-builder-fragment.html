<section class="ew-t17-ui" data-t17-ui>
  ...
  <div class="ew-t17-ui__workspace">
    ...
    <section class="ew-t17-ui__catalog" aria-label="Materials">
      ...
      <div class="ew-t17-ui__library-body"><aside class="ew-t17-ui__filter-panel"><span class="ew-t17-ui__filter-title">Category</span><div class="ew-t17-ui__categories" data-categories aria-label="Material category"></div></aside><div class="ew-t17-ui__library-results"><div class="ew-t17-ui__library-note">Use − / + to choose the size, then tap the card to add that Variant. Filters never alter the bracelet already on the tray.</div><div class="ew-t17-ui__grid" data-grid></div></div></div>
    </section>
  </div>
