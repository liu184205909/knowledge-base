...
// ============================================================
const CRYSTALS_AZ = [
  { name: 'Amethyst',         subtitle: 'The Stone of Peace',          image: IMAGES.crystals.amethyst.url,         link: '/gemstone/amethyst-meaning' },
  { name: 'Rose Quartz',      subtitle: 'The Stone of Love',           image: IMAGES.crystals.roseQuartz.url,      link: '/gemstone/rose-quartz-meaning' },
  { name: 'Citrine',          subtitle: 'The Stone of Abundance',      image: IMAGES.crystals.citrine.url,          link: '/gemstone/citrine-meaning' },
  { name: 'Black Tourmaline', subtitle: 'The Shield Stone',            image: IMAGES.crystals.blackTourmaline.url, link: '/gemstone/black-tourmaline-meaning' },
  { name: 'Clear Quartz',     subtitle: 'The Master Healer',           image: IMAGES.crystals.clearQuartz.url,     link: '/gemstone/clear-quartz-meaning' },
  { name: 'Tiger Eye',        subtitle: 'The Stone of Courage',        image: IMAGES.crystals.tigerEye.url,        link: '/gemstone/tiger-eye-meaning' },
  { name: 'Moonstone',        subtitle: 'The Stone of New Beginnings', image: IMAGES.crystals.moonstone.url,        link: '/gemstone/moonstone-meaning' },
  { name: 'Obsidian',         subtitle: 'The Mirror Stone',            image: IMAGES.crystals.obsidian.url,         link: '/gemstone/obsidian-meaning' },
  { name: 'Lepidolite',       subtitle: 'The Stone of Transition',     image: IMAGES.crystals.lepidolite.url,       link: '/gemstone/lepidolite-meaning' },
  { name: 'Selenite',         subtitle: 'The Stone of Clarity',        image: IMAGES.crystals.selenite.url,         link: '/gemstone/selenite-meaning' },
  { name: 'Green Aventurine', subtitle: 'The Stone of Luck',           image: IMAGES.crystals.greenAventurine.url, link: '/gemstone/green-aventurine-meaning' },
  { name: 'Fluorite',         subtitle: 'The Stone of Focus',          image: IMAGES.crystals.fluorite.url,         link: '/gemstone/fluorite-meaning' },
  { name: 'Howlite',          subtitle: 'The Stone of Calm',           image: IMAGES.crystals.howlite.url,          link: '/gemstone/howlite-meaning' },
  { name: 'Rhodonite',        subtitle: 'The Stone of Compassion',     image: IMAGES.crystals.rhodonite.url,        link: '/gemstone/rhodonite-meaning' },
  { name: 'Malachite',        subtitle: 'The Stone of Transformation', image: IMAGES.crystals.malachite.url,        link: '/gemstone/malachite-meaning' },
  { name: 'Hematite',         subtitle: 'The Grounding Stone',         image: IMAGES.crystals.hematite.url,         link: '/gemstone/hematite-meaning' }
];
...
// ============================================================
const CHAKRAS = [
  { name: 'Root Chakra',        sanskrit: 'Muladhara',    color: '#FF0000', colorName: 'Red',    link: '/root-chakra-crystals' },
  { name: 'Sacral Chakra',      sanskrit: 'Svadhisthana', color: '#FF8C00', colorName: 'Orange', link: '/sacral-chakra-crystals' },
  { name: 'Solar Plexus',       sanskrit: 'Manipura',     color: '#FFD700', colorName: 'Yellow', link: '/solar-plexus-chakra-crystals' },
  { name: 'Heart Chakra',       sanskrit: 'Anahata',      color: '#00CC00', colorName: 'Green',  link: '/heart-chakra-crystals' },
  { name: 'Throat Chakra',      sanskrit: 'Vishuddha',    color: '#0099FF', colorName: 'Blue',   link: '/throat-chakra-crystals' },
  { name: 'Third Eye Chakra',   sanskrit: 'Ajna',         color: '#4B0082', colorName: 'Indigo', link: '/third-eye-chakra-crystals' },
  { name: 'Crown Chakra',       sanskrit: 'Sahasrara',    color: '#9400D3', colorName: 'Violet', link: '/crown-chakra-crystals' }
];
...
// ============================================================
const ZODIACS = [
  { name: 'Aries',       symbol: '\u2648', dates: 'Mar 21 \u2013 Apr 19',  link: '/aries-crystals' },
  { name: 'Taurus',      symbol: '\u2649', dates: 'Apr 20 \u2013 May 20',  link: '/taurus-crystals' },
  { name: 'Gemini',      symbol: '\u264A', dates: 'May 21 \u2013 Jun 20',  link: '/gemini-crystals' },
  { name: 'Cancer',      symbol: '\u264B', dates: 'Jun 21 \u2013 Jul 22',  link: '/cancer-crystals' },
  { name: 'Leo',         symbol: '\u264C', dates: 'Jul 23 \u2013 Aug 22',  link: '/leo-crystals' },
  { name: 'Virgo',       symbol: '\u264D', dates: 'Aug 23 \u2013 Sep 22',  link: '/virgo-crystals' },
  { name: 'Libra',       symbol: '\u264E', dates: 'Sep 23 \u2013 Oct 22',  link: '/libra-crystals' },
  { name: 'Scorpio',     symbol: '\u264F', dates: 'Oct 23 \u2013 Nov 21',  link: '/scorpio-crystals' },
  { name: 'Sagittarius', symbol: '\u2650', dates: 'Nov 22 \u2013 Dec 21',  link: '/sagittarius-crystals' },
  { name: 'Capricorn',   symbol: '\u2651', dates: 'Dec 22 \u2013 Jan 19',  link: '/capricorn-crystals' },
  { name: 'Aquarius',    symbol: '\u2652', dates: 'Jan 20 \u2013 Feb 18',  link: '/aquarius-crystals' },
  { name: 'Pisces',      symbol: '\u2653', dates: 'Feb 19 \u2013 Mar 20',  link: '/pisces-crystals' }
];
...
// ============================================================
const COLORS = [
  { name: 'Red Crystals',    color: '#E74C3C', link: '/red-crystals' },
  { name: 'Orange Crystals', color: '#E67E22', link: '/orange-crystals' },
  { name: 'Yellow Crystals', color: '#F1C40F', link: '/yellow-crystals' },
  { name: 'Green Crystals',  color: '#2ECC71', link: '/green-crystals' },
  { name: 'Blue Crystals',   color: '#3498DB', link: '/blue-crystals' },
  { name: 'Purple Crystals', color: '#9B59B6', link: '/purple-crystals' },
  { name: 'Pink Crystals',   color: '#E91E8C', link: '/pink-crystals' },
  { name: 'White Crystals',  color: '#ECF0F1', link: '/white-crystals' },
  { name: 'Black Crystals',  color: '#2C3E50', link: '/black-crystals' },
  { name: 'Brown Crystals',  color: '#8B6914', link: '/brown-crystals' },
  { name: 'Gold Crystals',   color: '#DAA520', link: '/gold-crystals' },
  { name: 'Clear Crystals',  color: '#D5DBDB', link: '/clear-crystals' }
];
...
function generateCrystalGuideIndex() {
  ...
  var conditionCards = CONDITIONS.map(function (cond) {
    return E.wrap(Object.assign({
      ...
      E.buttonWidget('Explore', '/crystals-for-' + cond.slug)
    ]);
  });
