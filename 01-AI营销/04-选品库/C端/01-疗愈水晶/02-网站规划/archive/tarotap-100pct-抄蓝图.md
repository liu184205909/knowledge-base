...
| **每日运势（1 张）** | ✅ **已裁决作废文章化**（2026-07-02，SERP 证伪日期长尾）→ 改 **1 工具页** `/tools/daily-tarot/`（post 50319，JS 日期种子出牌），见 [daily-tarot PRD](../07-互动工具/daily-tarot/PRD.md)。~~原"新建每日一牌文章"~~ 不做 | ✅ 工具页已上线 | — |
