/**
 * Numerology 主词页 AI 填充回填：读 _placeholders-planet-in-sign/{slug}.txt（@@@格式）
 * → 替换 articles-planet-in-sign/{slug}.json 里所有 {{AI_*}} 占位符
...
const idx = JSON.parse(fs.readFileSync(path.join(DIR, 'articles-planet-in-sign-index.json'), 'utf8'));
