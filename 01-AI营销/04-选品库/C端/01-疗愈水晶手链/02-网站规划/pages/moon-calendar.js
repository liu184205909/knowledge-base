...
function generateMoonCalendarPage(config) {
  ...
  var currentCrystals = config.currentCrystals || [
    { name: 'Moonstone', link: '/crystal-guide/moonstone-meaning' },
    { name: 'Clear Quartz', link: '/crystal-guide/clear-quartz-meaning' },
    { name: 'Selenite', link: '/crystal-guide/selenite-meaning' }
  ];
  var nextNewMoon = config.nextNewMoon || { date: 'May 4, 2026', zodiac: 'Taurus', theme: 'Abundance & Grounding', crystals: [{ name: 'Citrine', link: '/crystal-guide/citrine-meaning' }, { name: 'Green Aventurine', link: '/crystal-guide/green-aventurine-meaning' }] };
  var nextFullMoon = config.nextFullMoon || { date: 'May 19, 2026', zodiac: 'Sagittarius', theme: 'Expansion & Adventure', crystals: [{ name: 'Lapis Lazuli', link: '/crystal-guide/lapis-lazuli-meaning' }, { name: 'Labradorite', link: '/crystal-guide/labradorite-meaning' }] };
...
async function main() {
  var config = {
    ...
    nextNewMoon: {
      ...
      crystals: [
        { name: 'Citrine', link: '/crystal-guide/citrine-meaning' },
        { name: 'Green Aventurine', link: '/crystal-guide/green-aventurine-meaning' },
        { name: 'Pyrite', link: '/crystal-guide/pyrite-meaning' }
      ]
    },
    nextFullMoon: {
      date: 'May 19, 2026',
      ...
      crystals: [
        { name: 'Lapis Lazuli', link: '/crystal-guide/lapis-lazuli-meaning' },
        { name: 'Labradorite', link: '/crystal-guide/labradorite-meaning' }
      ]
    }
  };
