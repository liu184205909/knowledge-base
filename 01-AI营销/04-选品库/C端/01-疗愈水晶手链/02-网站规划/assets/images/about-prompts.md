...
## 2. about.founder — 意念设定工作台

- **文件名**: `about-intention-setting-workspace-v1.png`
- **尺寸**: 800 x 800
- **用途**: About 页面 Section 3 意念设定艺术配图（"The Art of Intention-Setting"），展示水晶手链制作和意念设定的过程场景
- **Alt**: `Crystal bracelet intention-setting workspace with cleansing tools`
- **Prompt**:
```
...
## 3. about.natural — 品质承诺图标：100%天然水晶

- **文件名**: `about-icon-natural-crystals-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 6 品质承诺图标 1（"100% Natural Crystals"），圆形裁剪 70px
- **Alt**: `Natural raw and polished crystal pair showing authentic texture`
- **Prompt**:
```
...
## 4. about.cleansing — 品质承诺图标：净化充能

- **文件名**: `about-icon-cleansing-charged-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 6 品质承诺图标 2（"Energetically Cleansed & Charged"），圆形裁剪 70px
- **Alt**: `Crystal bracelet being cleansed with sage smoke and moonlight`
- **Prompt**:
```
...
## 5. about.packaging — 品质承诺图标：丝绒袋+指南卡

- **文件名**: `about-icon-velvet-pouch-guide-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 6 品质承诺图标 3（"Velvet Pouch + Guide Card Included"），圆形裁剪 70px
- **Alt**: `Velvet pouch and crystal energy guide card gift packaging`
- **Prompt**:
```
...
## 6. about.returns — 品质承诺图标：30天退换

- **文件名**: `about-icon-returns-guarantee-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 6 品质承诺图标 4（"30-Day Worry-Free Returns"），圆形裁剪 70px
- **Alt**: `Crystal bracelet order package with care return card`
- **Prompt**:
```
...
## 7. about.communityRose — 用户故事：Rose Quartz

- **文件名**: `about-community-rose-quartz-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 7 用户故事 1（Amanda K. — Rose Quartz Bracelet），圆形裁剪 60px
- **Alt**: `Rose quartz crystal bracelet with self-love journaling scene`
- **Prompt**:
```
...
## 8. about.communityProtection — 用户故事：Black Tourmaline

- **文件名**: `about-community-black-tourmaline-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 7 用户故事 2（David R. — Black Tourmaline Bracelet），圆形裁剪 60px
- **Alt**: `Black tourmaline crystal bracelet with grounding desk scene`
- **Prompt**:
```
...
## 9. about.communityAmethyst — 用户故事：Amethyst

- **文件名**: `about-community-amethyst-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 7 用户故事 3（Sophie L. — Amethyst Bracelet），圆形裁剪 60px
- **Alt**: `Amethyst crystal bracelet with calming study scene`
- **Prompt**:
```
...
## 10. about.communityCitrine — 用户故事：Citrine

- **文件名**: `about-community-citrine-v1.png`
- **尺寸**: 400 x 400
- **用途**: About 页面 Section 7 用户故事 4（Mia T. — Citrine Bracelet），圆形裁剪 60px
- **Alt**: `Citrine crystal bracelet with abundance entrepreneurship scene`
- **Prompt**:
```
...
- **文件名**: `about-cta-find-your-crystal-v1.png`
- **尺寸**: 1920 x 900
- **用途**: About 页面 Section 8 CTA 背景图（"Ready to Find Your Crystal?"），深色叠层 overlay 0.7
- **Alt**: `Discover your perfect crystal bracelet with intention-setting tools`
- **Prompt**:
```
...
1. **逐张生成**: 用 Codex 内置生图（image-2 模型），按上方 prompt 逐张生成
2. **质量验收**: 检查无文字、无人脸、无手部、尺寸匹配、视觉风格统一
3. **复制入库**: 复制到 `assets/images/generated/` 目录，文件名与上方一致
4. **上传 WP**: 通过 `POST /wp-json/wp/v2/media` 上传到 WordPress 媒体库
5. **回写 URL**: 更新 `site-images.js` 中每个条目的 `url` 和 `status`（改为 `source_generated_wp_upload`）
6. **上传页面**: 执行 `node pages/about.js` 创建 draft 页面
7. **验收页面**: 检查所有图片、H1/H2/H3、内链、布局
