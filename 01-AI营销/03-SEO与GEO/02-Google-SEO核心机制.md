...
> 来源：Glenn Gabe 追踪数据，鸭老师SEO 整理。2026年5月核心更新：5月21日开始，6月2日完成，历时11天，比3月更新更猛烈。
...
> **权威度是发散的"赦免状"**（鸭老师SEO，B2B行业6站向量对比验证）：在权威度相近的站点之间，内容聚合程度几乎决定了流量效率；高权威站点可以用权威补偿发散的内容半径。对绝大多数中小站点，把内容点云收紧是唯一不依赖外部资源的效率杠杆。siteFocusScore（站点主题专注度）和 siteRadius（页面 embedding 偏离整站 embedding 的程度）相互印证：Google 在站点层面度量内容点云的紧凑程度，权威信号与主题信号在排名中**相乘而非相加**——任何一项接近零，另一项再大也救不回来。
