...
**核心原则**: 把重复的操作序列转化为可复用的Skills或Commands

**识别信号**:
某个操作序列你重复执行3次以上 → 立即创建Skill或Command

**实战案例**:

**案例1: 技术债务记录 (/techdebt)**
```
场景: 每次发现代码问题都要手动记录到文档
创建: /techdebt命令
效果: 一行命令自动记录问题、位置、优先级
```

**案例2: 上下文同步**
```
场景: 切换任务时要反复解释项目背景
创建: context-sync Skill
效果: 自动读取项目文档，快速同步上下文
```
