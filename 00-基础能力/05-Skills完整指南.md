...
#### **Superpowers** ⭐ 强烈推荐
- **GitHub**: 1.6万Star
- **功能**: 全流程开发增强(包含brainstorming, documentation, development, testing)
- **核心特性**:
  - 头脑风暴和创意生成
  - 文档自动生成
  - 开发流程优化
  - 测试用例生成
- **适合**: 所有开发者,提升全流程效率
- **仓库**: [搜索GitHub: Superpowers Claude Skill]

#### **planning-with-files** ⭐ 推荐
- **功能**: 基于文件的任务规划(参考Manus的Agent方法)
- **核心特性**:
  - 分析项目结构
  - 生成实施计划
  - 多步骤任务拆分
- **场景**: 接手新项目、复杂功能开发
- **优势**: 适合多步骤任务,参考Manus架构
