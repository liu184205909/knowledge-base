...
| Skill | 核心能力 | 典型场景 |
|-------|---------|---------|
| `pdf` | PDF合并/拆分/文本提取 | 发票批量处理、PDF转Word |
| `docsx` | Word合同模板生成 | 签名框、结构化元素自动生成 |
| `pptx` | PPT自动生成+品牌规范 | 符合设计规范的演示文稿 |

**数据分析类**:
| Skill | 核心能力 | 典型场景 |
|-------|---------|---------|
| `xlsx` | 非标表格处理 | 外贸PI单、复杂财务报表 |
| `brand-guidelines` | Anthropic品牌设计 | 网站设计、海报、PPT规范 |

**研究创作类**:
| Skill | 核心能力 | 典型场景 |
|-------|---------|---------|
| `research-to-diagram` | 一句话调研+自动画图 | 人物关系图、架构图、流程图 |
| `article-copilot` | 素材→正文自动化 | 文章生产流水线 |

**个性化AI**:
| Skill | 核心能力 | 典型场景 |
|-------|---------|---------|
| `ai-partner` | 基于记忆的AI伴侣 | 懂你的个性化助手 |

### 快速开始

**想要开发Skill**:
→ 见 [04-Skills完整指南.md](./04-Skills完整指南.md)

**想要推荐Skills**:
→ 见 [04-Skills完整指南.md](./04-Skills完整指南.md#推荐skills)
